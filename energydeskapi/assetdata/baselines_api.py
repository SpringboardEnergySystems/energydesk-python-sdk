...
class BaselinesApi:
    ...
    """
    @staticmethod
    def generate_baselines(api_connection: ApiConnection,  payload):

        success, json_res, status_code, error_msg = api_connection.exec_post_url('/api/baselines/generatebaseline/', payload)
        return success, json_res, status_code, error_msg

    @staticmethod
    def upsert_algorithm_instance(api_connection: ApiConnection, payload):
    ...
    @staticmethod
    def get_baselines_algorithm_url(api_connection: ApiConnection, algorithm_enum):
    ...
    @staticmethod
    def get_baselines_resolutions_url(api_connection: ApiConnection, resolution_enum):
        """Fetches algo type from url
        """
