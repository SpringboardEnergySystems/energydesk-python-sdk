...
class ClearingApi:
    ...
    @staticmethod
    def query_clearing_report_data(api_connection, clearing_house, clearing_type, from_date, to_date):
        ...
        :param clearing_type: type of clearing report
        :type clearing_type: str, required
        ...
        payload = {"clearing_house": clearing_house,
                   "clearing_report_type": clearing_type,
